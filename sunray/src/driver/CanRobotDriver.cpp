...
void CanMotorDriver::getMotorFaults(bool &leftFault, bool &rightFault, bool &mowFault){
  ...
  if (canRobot.motorFault){
    ...
    CONSOLE.println(canRobot.mow2Curr);
  }
  mowFault = false;
}
...
void CanMotorDriver::getMotorCurrent(float &leftCurrent, float &rightCurrent, float &mowCurrent, float &mow2Current) {  
  //leftCurrent = 0.5;
  //rightCurrent = 0.5;
  //mowCurrent = 0.8;
